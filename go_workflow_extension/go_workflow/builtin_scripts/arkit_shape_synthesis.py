...
MMD_POSSIBLE_RECIPES_CONSERVATIVE.update(
    {
        "あ2": [("JawOpen", 0.72), ("MouthFunnel", 0.08), ("MouthSmileLeft", 0.10), ("MouthSmileRight", 0.10)],
        "い2": [("MouthSmileLeft", 0.42), ("MouthSmileRight", 0.42), ("MouthStretchLeft", 0.18), ("MouthStretchRight", 0.18)],
        "う2": [("MouthPucker", 0.62), ("MouthFunnel", 0.38), ("MouthClose", 0.10)],
        "え2": [("JawOpen", 0.26), ("MouthSmileLeft", 0.30), ("MouthSmileRight", 0.30), ("MouthStretchLeft", 0.18), ("MouthStretchRight", 0.18)],
        "お2": [("JawOpen", 0.28), ("MouthFunnel", 0.64), ("MouthPucker", 0.26)],
        "ワ": [("JawOpen", 0.70), ("MouthStretchLeft", 0.24), ("MouthStretchRight", 0.24)],
        "ん": [("MouthClose", 0.55), ("MouthPressLeft", 0.22), ("MouthPressRight", 0.22)],
        "ω": [("MouthPucker", 0.26), ("MouthSmileLeft", 0.24), ("MouthSmileRight", 0.24), ("MouthDimpleLeft", 0.20), ("MouthDimpleRight", 0.20)],
        "△": [("JawOpen", 0.42), ("MouthFunnel", 0.34), ("MouthStretchLeft", 0.14), ("MouthStretchRight", 0.14)],
        "▲": [("MouthClose", 0.30), ("MouthFunnel", 0.28), ("MouthPucker", 0.20)],
        "瞳小": [("EyeWideLeft", 0.30), ("EyeWideRight", 0.30), ("BrowInnerUp", 0.12)],
        "瞳大": [("EyeWideLeft", 0.18), ("EyeWideRight", 0.18), ("CheekSquintLeft", 0.10), ("CheekSquintRight", 0.10)],
        "瞳縦": [("EyeWideLeft", 0.20), ("EyeWideRight", 0.20), ("BrowDownLeft", 0.08), ("BrowDownRight", 0.08)],
        "瞳横": [("EyeSquintLeft", 0.22), ("EyeSquintRight", 0.22), ("CheekSquintLeft", 0.10), ("CheekSquintRight", 0.10)],
        "白目": [("EyeWideLeft", 0.46), ("EyeWideRight", 0.46), ("BrowInnerUp", 0.18), ("JawOpen", 0.12)],
        "涙目": [("BrowInnerUp", 0.36), ("EyeBlinkLeft", 0.12), ("EyeBlinkRight", 0.12), ("MouthFrownLeft", 0.16), ("MouthFrownRight", 0.16)],
        "真面目": [("BrowDownLeft", 0.20), ("BrowDownRight", 0.20), ("EyeSquintLeft", 0.14), ("EyeSquintRight", 0.14)],
        "悲しい": [("BrowInnerUp", 0.42), ("MouthFrownLeft", 0.30), ("MouthFrownRight", 0.30)],
        "驚き": [("EyeWideLeft", 0.36), ("EyeWideRight", 0.36), ("BrowInnerUp", 0.24), ("BrowOuterUpLeft", 0.22), ("BrowOuterUpRight", 0.22), ("JawOpen", 0.32)],
        "下がり眉": [("BrowInnerUp", 0.30), ("BrowDownLeft", 0.10), ("BrowDownRight", 0.10)],
        "口横狭め": [("MouthPucker", 0.34), ("MouthFunnel", 0.18), ("MouthClose", 0.10)],
        "口縦広げ": [("JawOpen", 0.58), ("MouthFunnel", 0.18)],
        "口縦狭め": [("MouthClose", 0.34), ("MouthRollLower", 0.20), ("MouthRollUpper", 0.16)],
        "口開け": [("JawOpen", 0.70)],
        "口閉じ": [("MouthClose", 0.65), ("MouthPressLeft", 0.16), ("MouthPressRight", 0.16)],
        "口すぼめ": [("MouthPucker", 0.58), ("MouthFunnel", 0.22)],
        "口笛": [("MouthPucker", 0.66), ("MouthFunnel", 0.32)],
        "口ぷく": [("CheekPuff", 0.82), ("MouthClose", 0.24)],
        "舌出し": [("TongueOut", 0.92), ("JawOpen", 0.14)],
        "頬染め": [("CheekSquintLeft", 0.22), ("CheekSquintRight", 0.22), ("MouthSmileLeft", 0.12), ("MouthSmileRight", 0.12)],
        "照れ": [("CheekSquintLeft", 0.24), ("CheekSquintRight", 0.24), ("BrowInnerUp", 0.12), ("MouthSmileLeft", 0.12), ("MouthSmileRight", 0.12)],
        "涙": [("BrowInnerUp", 0.42), ("MouthFrownLeft", 0.28), ("MouthFrownRight", 0.28), ("EyeBlinkLeft", 0.10), ("EyeBlinkRight", 0.10)],
        "汗": [("BrowInnerUp", 0.18), ("EyeWideLeft", 0.12), ("EyeWideRight", 0.12), ("MouthStretchLeft", 0.14), ("MouthStretchRight", 0.14)],
        "青ざめ": [("EyeWideLeft", 0.28), ("EyeWideRight", 0.28), ("BrowInnerUp", 0.22), ("MouthFrownLeft", 0.14), ("MouthFrownRight", 0.14)],
        "赤面": [("CheekSquintLeft", 0.26), ("CheekSquintRight", 0.26), ("MouthSmileLeft", 0.16), ("MouthSmileRight", 0.16)],
        "困惑": [("BrowInnerUp", 0.28), ("EyeWideLeft", 0.14), ("EyeWideRight", 0.14), ("MouthStretchLeft", 0.18), ("MouthStretchRight", 0.18)],
        "青筋": [("BrowDownLeft", 0.32), ("BrowDownRight", 0.32), ("NoseSneerLeft", 0.18), ("NoseSneerRight", 0.18)],
        "怒りマーク": [("BrowDownLeft", 0.36), ("BrowDownRight", 0.36), ("NoseSneerLeft", 0.20), ("NoseSneerRight", 0.20)],
        "シャドー": [("BrowInnerUp", 0.26), ("EyeWideLeft", 0.18), ("EyeWideRight", 0.18), ("MouthFrownLeft", 0.18), ("MouthFrownRight", 0.18)],
        "影": [("BrowInnerUp", 0.22), ("EyeWideLeft", 0.14), ("EyeWideRight", 0.14), ("MouthFrownLeft", 0.16), ("MouthFrownRight", 0.16)],
        "ガーン": [("BrowInnerUp", 0.34), ("EyeWideLeft", 0.30), ("EyeWideRight", 0.30), ("JawOpen", 0.26), ("MouthFrownLeft", 0.16), ("MouthFrownRight", 0.16)],
        "照れ線": [("CheekSquintLeft", 0.24), ("CheekSquintRight", 0.24), ("MouthSmileLeft", 0.10), ("MouthSmileRight", 0.10)],
    }
)

MMD_POSSIBLE_RECIPES_AGGRESSIVE.update(
    {
        "あ2": [("JawOpen", 0.84), ("MouthFunnel", 0.12), ("MouthSmileLeft", 0.14), ("MouthSmileRight", 0.14)],
        "い2": [("MouthSmileLeft", 0.50), ("MouthSmileRight", 0.50), ("MouthStretchLeft", 0.24), ("MouthStretchRight", 0.24)],
        "う2": [("MouthPucker", 0.74), ("MouthFunnel", 0.48), ("MouthClose", 0.14)],
        "え2": [("JawOpen", 0.34), ("MouthSmileLeft", 0.38), ("MouthSmileRight", 0.38), ("MouthStretchLeft", 0.24), ("MouthStretchRight", 0.24)],
        "お2": [("JawOpen", 0.36), ("MouthFunnel", 0.76), ("MouthPucker", 0.34)],
        "ワ": [("JawOpen", 0.84), ("MouthStretchLeft", 0.32), ("MouthStretchRight", 0.32)],
        "ん": [("MouthClose", 0.70), ("MouthPressLeft", 0.30), ("MouthPressRight", 0.30)],
        "ω": [("MouthPucker", 0.34), ("MouthSmileLeft", 0.32), ("MouthSmileRight", 0.32), ("MouthDimpleLeft", 0.26), ("MouthDimpleRight", 0.26)],
        "△": [("JawOpen", 0.54), ("MouthFunnel", 0.44), ("MouthStretchLeft", 0.18), ("MouthStretchRight", 0.18)],
        "▲": [("MouthClose", 0.42), ("MouthFunnel", 0.34), ("MouthPucker", 0.28)],
        "瞳小": [("EyeWideLeft", 0.40), ("EyeWideRight", 0.40), ("BrowInnerUp", 0.16)],
        "瞳大": [("EyeWideLeft", 0.26), ("EyeWideRight", 0.26), ("CheekSquintLeft", 0.14), ("CheekSquintRight", 0.14)],
        "瞳縦": [("EyeWideLeft", 0.28), ("EyeWideRight", 0.28), ("BrowDownLeft", 0.12), ("BrowDownRight", 0.12)],
        "瞳横": [("EyeSquintLeft", 0.32), ("EyeSquintRight", 0.32), ("CheekSquintLeft", 0.14), ("CheekSquintRight", 0.14)],
        "白目": [("EyeWideLeft", 0.58), ("EyeWideRight", 0.58), ("BrowInnerUp", 0.24), ("JawOpen", 0.16)],
        "涙目": [("BrowInnerUp", 0.46), ("EyeBlinkLeft", 0.16), ("EyeBlinkRight", 0.16), ("MouthFrownLeft", 0.22), ("MouthFrownRight", 0.22)],
        "真面目": [("BrowDownLeft", 0.28), ("BrowDownRight", 0.28), ("EyeSquintLeft", 0.20), ("EyeSquintRight", 0.20)],
        "悲しい": [("BrowInnerUp", 0.52), ("MouthFrownLeft", 0.38), ("MouthFrownRight", 0.38)],
        "驚き": [("EyeWideLeft", 0.48), ("EyeWideRight", 0.48), ("BrowInnerUp", 0.32), ("BrowOuterUpLeft", 0.28), ("BrowOuterUpRight", 0.28), ("JawOpen", 0.42)],
        "下がり眉": [("BrowInnerUp", 0.38), ("BrowDownLeft", 0.14), ("BrowDownRight", 0.14)],
        "口横狭め": [("MouthPucker", 0.44), ("MouthFunnel", 0.24), ("MouthClose", 0.14)],
        "口縦広げ": [("JawOpen", 0.72), ("MouthFunnel", 0.24)],
        "口縦狭め": [("MouthClose", 0.44), ("MouthRollLower", 0.28), ("MouthRollUpper", 0.22)],
        "口開け": [("JawOpen", 0.84)],
        "口閉じ": [("MouthClose", 0.80), ("MouthPressLeft", 0.22), ("MouthPressRight", 0.22)],
        "口すぼめ": [("MouthPucker", 0.72), ("MouthFunnel", 0.30)],
        "口笛": [("MouthPucker", 0.82), ("MouthFunnel", 0.42)],
        "口ぷく": [("CheekPuff", 0.94), ("MouthClose", 0.32)],
        "舌出し": [("TongueOut", 0.96), ("JawOpen", 0.18)],
        "頬染め": [("CheekSquintLeft", 0.30), ("CheekSquintRight", 0.30), ("MouthSmileLeft", 0.16), ("MouthSmileRight", 0.16)],
        "照れ": [("CheekSquintLeft", 0.32), ("CheekSquintRight", 0.32), ("BrowInnerUp", 0.18), ("MouthSmileLeft", 0.16), ("MouthSmileRight", 0.16)],
        "涙": [("BrowInnerUp", 0.52), ("MouthFrownLeft", 0.36), ("MouthFrownRight", 0.36), ("EyeBlinkLeft", 0.14), ("EyeBlinkRight", 0.14)],
        "汗": [("BrowInnerUp", 0.24), ("EyeWideLeft", 0.18), ("EyeWideRight", 0.18), ("MouthStretchLeft", 0.18), ("MouthStretchRight", 0.18)],
        "青ざめ": [("EyeWideLeft", 0.38), ("EyeWideRight", 0.38), ("BrowInnerUp", 0.30), ("MouthFrownLeft", 0.20), ("MouthFrownRight", 0.20)],
        "赤面": [("CheekSquintLeft", 0.34), ("CheekSquintRight", 0.34), ("MouthSmileLeft", 0.20), ("MouthSmileRight", 0.20)],
        "困惑": [("BrowInnerUp", 0.36), ("EyeWideLeft", 0.20), ("EyeWideRight", 0.20), ("MouthStretchLeft", 0.24), ("MouthStretchRight", 0.24)],
        "青筋": [("BrowDownLeft", 0.42), ("BrowDownRight", 0.42), ("NoseSneerLeft", 0.24), ("NoseSneerRight", 0.24)],
        "怒りマーク": [("BrowDownLeft", 0.46), ("BrowDownRight", 0.46), ("NoseSneerLeft", 0.28), ("NoseSneerRight", 0.28)],
        "シャドー": [("BrowInnerUp", 0.34), ("EyeWideLeft", 0.24), ("EyeWideRight", 0.24), ("MouthFrownLeft", 0.24), ("MouthFrownRight", 0.24)],
        "影": [("BrowInnerUp", 0.30), ("EyeWideLeft", 0.20), ("EyeWideRight", 0.20), ("MouthFrownLeft", 0.22), ("MouthFrownRight", 0.22)],
        "ガーン": [("BrowInnerUp", 0.44), ("EyeWideLeft", 0.40), ("EyeWideRight", 0.40), ("JawOpen", 0.34), ("MouthFrownLeft", 0.22), ("MouthFrownRight", 0.22)],
        "照れ線": [("CheekSquintLeft", 0.32), ("CheekSquintRight", 0.32), ("MouthSmileLeft", 0.14), ("MouthSmileRight", 0.14)],
    }
)
TABLE_RULES = """混合系数表规则
